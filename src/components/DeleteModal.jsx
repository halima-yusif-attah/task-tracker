...
function DeleteModal({id, label}) {
  ...
  return (
    <div className="w-full h-[100vh] bg-gray-800 flex items-center justify-center p-4">
      <div className="w-fit border border-slate-400 bg-slate-400 p-4 flex space-y-2 flex-col">
